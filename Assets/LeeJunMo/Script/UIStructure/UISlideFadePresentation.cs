...
/// <summary>
/// Reusable slide/fade presentation for UI roots.
/// </summary>
[DisallowMultipleComponent]
public class UISlideFadePresentation : MonoBehaviour
{
    [Header("References")]
    ...
    public RectTransform TargetRoot => targetRoot != null ? targetRoot : transform as RectTransform;
    public CanvasGroup CanvasGroup => canvasGroup;
    public bool IsAnimating => activeRoutine != null;
    public bool DeactivateAfterClose
    {
        get => deactivateAfterClose;
        set => deactivateAfterClose = value;
    }
    ...
    {
        PlayOpen(null, animate);
    }

    public void PlayOpen(Action onComplete, bool animate = true)
    {
        ResolveReferences();
    ...
    public void ClearCapturedOpenPosition()
    {
        hasOpenAnchoredPosition = false;
    }

    public void Configure(RectTransform root, CanvasGroup group = null)
    {
        targetRoot = root;
        canvasGroup = group != null ? group : root != null ? root.GetComponent<CanvasGroup>() : null;
        hasOpenAnchoredPosition = false;
        ResolveReferences();
    }
    ...
    private void ResolveReferences()
    {
        ...
        if (canvasGroup == null && targetRoot != null)
