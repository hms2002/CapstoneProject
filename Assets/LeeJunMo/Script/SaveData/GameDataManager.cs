...
public class GameDataManager : MonoBehaviour
{
    ...
    public List<AffectionRecord> GetAffectionRecordsSnapshot()
    {
        if (Data == null || Data.affectionData == null || Data.affectionData.affectionRecords == null)
            return new List<AffectionRecord>();

        return new List<AffectionRecord>(Data.affectionData.affectionRecords);
    }

    public int GetAffectionValue(int npcId)
    {
        if (Data == null || Data.affectionData == null || Data.affectionData.affectionRecords == null)
            return 0;

        var record = Data.affectionData.affectionRecords.Find(x => x.npcId == npcId);
        return record != null ? record.amount : 0;
    }

    public void SetAffectionValue(int npcId, int amount)
    {
        if (Data == null)
            return;
        ...
        if (record != null)
            ...
            Data.affectionData.affectionRecords.Add(new AffectionRecord(npcId, amount));
    }
