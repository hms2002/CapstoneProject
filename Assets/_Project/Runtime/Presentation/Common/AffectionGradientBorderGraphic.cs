...
/// <summary>
/// 책임 : 화면 가장자리 그라데이션 테두리를 MaskableGraphic 메시와 shader channel 값으로 그린다.
/// </summary>
public sealed class AffectionGradientBorderGraphic : MaskableGraphic
{
    ...
    [Tooltip("Runtime alpha multiplier. The affection gain screen effect controls this during preview/play.")]
