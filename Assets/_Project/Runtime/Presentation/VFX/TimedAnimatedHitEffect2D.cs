...
namespace UnityGAS
{
    ...
    public sealed class TimedAnimatedHitEffect2D : MonoBehaviour, ITimedHitEffect2D
    {
        ...
        public void Play(float lifetimeSeconds, CombatHitPayload hitPayload, SharedHitRegistry2D registry = null)
        {
        ...
        /// <summary>
        /// 책임: 기존 TimedAnimatedHitEffect2D.SharedHitRegistry 호출부를 Core SharedHitRegistry2D로 연결하는 호환 타입이다.
        /// </summary>
        public sealed class SharedHitRegistry : SharedHitRegistry2D
        {
        }
    }
}
