...
namespace UnityGAS
{
    ...
    public sealed class AttackTelegraphView : MonoBehaviour, IAttackTelegraphHandle
    {
        ...
        /// <summary>
        /// 책임: Gameplay 계약 핸들이 fallback style 세부사항 없이 텔레그래프 뷰를 표시하게 연결한다.
        /// </summary>
        void IAttackTelegraphHandle.Show(AttackTelegraphSpec spec)
        {
            Show(spec);
        }
        ...
        /// <summary>
        /// 책임 :
        /// - Gameplay 계약 핸들이 구체 GameObject를 알 필요 없이 텔레그래프 표시를 숨기고 인스턴스를 회수하게 한다.
        /// </summary>
        public void Release()
        {
