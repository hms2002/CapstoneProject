...
/// <summary>
/// 책임 : 튜토리얼 보스 컷씬용 presentation HP 텍스트/슬롯/하트 UI를 갱신하고 소진 이벤트를 발행한다.
/// </summary>
public sealed class TutorialPresentationHpView : MonoBehaviour, ITutorialPresentationHpView
{
    [Serializable]
