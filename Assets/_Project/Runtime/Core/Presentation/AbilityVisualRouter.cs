...
namespace UnityGAS
{
    ...
    public sealed class AbilityVisualRouter
    {
        ...
        /// <summary>
        /// 책임 :
        /// - Presentation backend가 spec 수명에 묶인 concrete visual component를 owner에 생성할 수 있게 한다.
        /// - Gameplay 로직이 owner GameObject를 직접 넘기지 않아도 router 소유자 기준으로 visual을 만들게 한다.
        /// </summary>
