...
/// <summary>
/// 책임 :
/// - UI/프레젠테이션 흐름이 플레이어 TagSystem에 입력 차단 tag set을 ref-count 방식으로 제공/회수하게 한다.
/// - 여러 잠금 주체가 동시에 요청해도 마지막 주체가 해제될 때까지 block tag가 유지되도록 조율한다.
/// </summary>
...
public sealed class PlayerUIControlLockBridge : MonoBehaviour
{
    ...
    /// <summary>
    /// 책임 :
    /// - 플레이어 Transform에서 입력 잠금 브리지를 찾아 반환하고, 없으면 즉시 생성해 요청 흐름이 끊기지 않게 한다.
    /// </summary>
