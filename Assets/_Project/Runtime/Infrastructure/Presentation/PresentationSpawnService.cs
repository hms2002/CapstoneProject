...
{
    /// <summary>
    /// 책임: presentation prefab 인스턴스의 resolve, spawn, prewarm, pool, release 수명 관리를 제공한다.
    /// </summary>
    ...
    {
        /// <summary>
        /// 책임: presentation prefab pool 상태를 debug view에 노출하기 위한 읽기 전용 행 데이터이다.
        /// </summary>
            ...
            bool coldSpawn)
        {
            ...
            PresentationPrewarmTracePlayback.RecordSpawn(resolvedPrefab, coldSpawn);
