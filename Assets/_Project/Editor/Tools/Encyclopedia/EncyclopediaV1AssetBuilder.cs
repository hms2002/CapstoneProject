...
{
    private const string CatalogPath = "Assets/_Project/Data/Encyclopedia/EncyclopediaCatalog.asset";
    private const string ScreenPrefabPath = "Assets/_Project/Prefabs/UI/PopupUI/Encyclopedia/EncyclopediaUI.prefab";
    private const string EntrySlotPrefabPath = "Assets/_Project/Prefabs/UI/PopupUI/Encyclopedia/EncyclopediaEntrySlot.prefab";
    private const string AbilityBlockPrefabPath = "Assets/_Project/Prefabs/UI/PopupUI/Encyclopedia/Panel_AbilityBlock_Encyclopedia.prefab";
    private const string StandPrefabPath = "Assets/_Project/Prefabs/Map/Interactables/EncyclopediaStand.prefab";
    private const string ItemDatabasePath = "Assets/_Project/Data/Items/ItemDatabase.asset";
    private const string PaperBookSpriteRoot = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites";
    ...
    private const string EarthTomeRoot = "Assets/_Project/Art/Sprites/UI/Encyclopedia/EarthTome";
    private const string AnimationRoot = "Assets/_Project/Art/Animations/Encyclopedia";
    ...
    private const string GalmuriFontPath = "Assets/_Project/Art/Fonts/Galmuri9 SDF.asset";
    ...
    private static List<EncyclopediaMonsterEntry> BuildMonsterEntries()
    {
        ...
        MonsterSeed[] seeds =
        {
            new("monster.beer", "Beer Monster", "주점 몬스터", "근접 추격", "드래곤 루트", "술기운에 반응하는 하급 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/BeerMonster.prefab"),
            new("monster.treasure", "Treasure Monster", "보물 몬스터", "접근 압박", "공용", "보물처럼 보이지만 전투를 유도하는 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/TreasureMonster.prefab"),
            new("monster.frog", "Frog", "일반 몬스터", "도약 공격", "초원/습지 계열", "빠르게 거리를 좁히는 개구리형 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/Frog.prefab"),
            new("monster.frog_elite", "Frog BOSS", "정예 몬스터", "강화 도약 공격", "초원/습지 계열", "일반 개구리보다 강한 정예 개체입니다.", "Assets/_Project/Prefabs/Monsters/Frog_BOSS.prefab"),
            new("monster.slime_pawn", "Pawn", "슬라임 병사", "직선 압박", "슬라임 복도", "앞을 향해 전진하는 슬라임 체스 병사입니다.", "Assets/_Project/Prefabs/Monsters/SlimeCorridor/Pawn.prefab"),
            new("monster.slime_rook", "Rook", "슬라임 병사", "직선 돌진", "슬라임 복도", "묵직하게 전열을 밀어내는 슬라임입니다.", "Assets/_Project/Prefabs/Monsters/SlimeCorridor/Rook.prefab"),
            new("monster.slime_knight", "Knight", "슬라임 병사", "변칙 이동", "슬라임 복도", "예측하기 어려운 이동으로 접근하는 슬라임입니다.", "Assets/_Project/Prefabs/Monsters/SlimeCorridor/Knight.prefab"),
            new("monster.slime_bishop", "Bishop", "슬라임 병사", "사선 압박", "슬라임 복도", "사선 위협을 담당하는 슬라임입니다.", "Assets/_Project/Prefabs/Monsters/SlimeCorridor/Bishop.prefab"),
            new("monster.slime_wizard", "Wizard", "슬라임 병사", "원거리 시전", "슬라임 복도", "마법 공격을 사용하는 슬라임입니다.", "Assets/_Project/Prefabs/Monsters/SlimeCorridor/Wizard.prefab"),
            new("monster.candlestick_corridor", "Corridor Candlestick", "그림자 몬스터", "고정형 위협", "그림자 복도", "어둠 속 시야와 위치를 압박하는 촛대 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/ShadowCorridor/CorridorCandlestickMonster.prefab"),
            new("monster.deads_skeleton", "Dead's Skeleton", "그림자 몬스터", "근접 공격", "그림자 복도", "죽은 자의 흔적을 품은 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/ShadowCorridor/Dead'sSkeleton.prefab"),
            new("monster.shadow", "Shadow Monster", "그림자 몬스터", "기습 공격", "그림자 복도", "어둠과 함께 움직이는 그림자 몬스터입니다.", "Assets/_Project/Prefabs/Monsters/ShadowCorridor/ShadowMonster.prefab"),
            new("monster.shadow_servant", "Shadow Servant", "그림자 하수인", "시야 교란", "그림자 복도", "날개와 검은 외장을 지닌 그림자 하수인입니다.", "Assets/_Project/Prefabs/Monsters/ShadowCorridor/ShadowServant/ShadowServant.prefab"),
            new("monster.strange_candlestick", "Strange Candlestick", "그림자 오브젝트 몬스터", "봉인/보조 패턴", "그림자 복도", "전투 흐름과 연결되는 기묘한 촛대입니다.", "Assets/_Project/Prefabs/Monsters/ShadowCorridor/StrangeCandlestick/StrangeCandlestick.prefab")
        };
    ...
    private static List<EncyclopediaBossEntry> BuildBossEntries()
    {
        ...
        BossSeed[] seeds =
        {
            new("boss.slime_queen", "Slime Queen", "보스", "점프/낙성 패턴/소환", "슬라임의 방", "슬라임 루트의 여왕 보스입니다.", "Assets/_Project/Prefabs/Bosses/SlimeQueen/SlimeQueen.prefab", null),
            new("boss.witch_chloe", "클로에", "보스", "투사체/시야 교란/광역 마법", "클로에의 방", "그림자 복도 중심에 있는 마녀 보스입니다.", "Assets/_Project/Prefabs/Bosses/ShadowBoss/Witch.prefab", "Assets/_Project/Data/Dialogue/NPC/ShadowBossNpc.asset"),
            new("boss.dragon", "Dragon", "보스", "돌진/화염/광역 사격", "드래곤의 방", "술기운을 머금은 드래곤 보스입니다.", "Assets/_Project/Prefabs/Bosses/DragonBoss/DragonBoss.prefab", "Assets/_Project/Data/Dialogue/NPC/DragonBossNpc.asset"),
            new("boss.demon_king", "마왕", "보스", "검격/사선/광역 패턴", "마왕의 방", "최종 루트의 마왕 보스입니다.", null, "Assets/_Project/Data/Dialogue/NPC/DarkLordNpcData.asset")
        };
