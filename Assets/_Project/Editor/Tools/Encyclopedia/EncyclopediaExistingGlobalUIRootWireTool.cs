...
public static class EncyclopediaExistingGlobalUIRootWireTool
{
    ...
    private const string EncyclopediaUIPrefabPath = "Assets/_Project/Prefabs/UI/PopupUI/Encyclopedia/EncyclopediaUI.prefab";
    ...
    private const string ContentAppearClipPath = "Assets/_Project/Art/Animations/Encyclopedia/UIBook/ENC_UIBook_ContentAppear.anim";
    private const string BookControllerPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/Book.controller";
    private const string BookIdleClipPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/BookIdle.anim";
    private const string BookOpenClipPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/BookOpen.anim";
    private const string BookCloseClipPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/BookClose.anim";
    private const string BookLeftPageClipPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/BookLeftPage.anim";
    private const string BookRightPageClipPath = "Assets/_Project/Art/Sprites/UI/Encyclopedia/Updated_Paper_Book/Sprites/BookRightPage.anim";
