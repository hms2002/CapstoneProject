...
public class UpgradeTreeEditor : EditorWindow
{
    ...
    private const string NodeFolder = "Assets/_Project/Resources/Upgrades/Nodes";
    private const string DefaultUpgradeTreePrefabPath = "Assets/_Project/Prefabs/UI/Upgrade/UpgradeTreePanel.prefab";
    ...
    private void EnsureNodeFolder()
    {
        ...
        if (!AssetDatabase.IsValidFolder("Assets/_Project/Resources/Upgrades"))
            AssetDatabase.CreateFolder("Assets/_Project/Resources", "Upgrades");

        if (!AssetDatabase.IsValidFolder(NodeFolder))
            AssetDatabase.CreateFolder("Assets/_Project/Resources/Upgrades", "Nodes");
    }
