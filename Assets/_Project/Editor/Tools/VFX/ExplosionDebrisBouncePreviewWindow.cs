...
internal sealed class ExplosionDebrisBouncePreviewWindow : EditorWindow
{
    private const string HighArcPath =
        "Assets/_Project/Resources/DemonKing/Vfx/PF_ExplosionDebrisBounce_HighArc.prefab";
    private const string DiagonalScatterPath =
        "Assets/_Project/Prefabs/VFX/Particle/ExplosionDebrisBounce/PF_ExplosionDebrisBounce_DiagonalScatter.prefab";
    private const string LowSkitterPath =
        "Assets/_Project/Prefabs/VFX/Particle/ExplosionDebrisBounce/PF_ExplosionDebrisBounce_LowSkitter.prefab";
