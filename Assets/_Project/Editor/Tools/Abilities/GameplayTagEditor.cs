...
namespace UnityGAS
{
    /// <summary>
    /// 책임:
    /// - GameplayTag asset tree를 편집하고 태그 상수 스크립트를 생성한다.
    /// </summary>
    public class GameplayTagEditor : EditorWindow
    {
        ...
        private const string TagAssetPath = "Assets/_Project/Resources/Tags";
        private const string GeneratedScriptPath = "Assets/_Project/Runtime/Core/Tags/UGAS_Tags.cs";
