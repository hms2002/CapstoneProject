...
public static class CommonMonsterAuthoringGenerator
{
    ...
    {
        EnsureFolder(AbilityDefinitionFolder);
        EnsureFolder(AbilityStrategyFolder);
    ...
    {
        string logicPath = $"{AbilityStrategyFolder}/AL_{abilityName}.asset";
        ...
        string abilityPath = $"{AbilityDefinitionFolder}/{assetName}.asset";
