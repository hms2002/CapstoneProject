...
public sealed class BossRewardRevealSceneValidatorWindow : EditorWindow
{
    ...
    private const string ChestDustPrefabPath = "Assets/_Project/Prefabs/VFX/Particle/ChestReavealDust.prefab";
    private const string GateLoopDustPrefabPath = "Assets/_Project/Prefabs/VFX/Particle/GateRevealLoopDust.prefab";
    private const string GateBurstDustPrefabPath = "Assets/_Project/Prefabs/VFX/Particle/GateRevealBurstDust.prefab";
    private const string RouteCatalogPath = "Assets/_Project/Data/SceneFlow/Routes/RunRouteCatalog.asset";
    private const string ShadowRouteSetPath = "Assets/_Project/Data/SceneFlow/Routes/ShadowCorridorBossRouteSet.asset";
    private const string DragonRouteSetPath = "Assets/_Project/Data/SceneFlow/Routes/Dragon_CorridorBossRouteSet.asset";
    private const string SlimeRouteSetPath = "Assets/_Project/Data/SceneFlow/Routes/SlimeRouteSet.asset";
    private const string DemonKingRouteSetPath = "Assets/_Project/Data/SceneFlow/Routes/DemonkingRouteSet.asset";
    ...
    {
        "Assets/_Project/Scenes/HeoMinSeok_Boss_Shadow.unity",
        "Assets/_Project/Scenes/HeoMinSeok_Boss_Dragon.unity",
        "Assets/_Project/Scenes/SangHyup_Boss_SlimeQueen.unity"
    };
