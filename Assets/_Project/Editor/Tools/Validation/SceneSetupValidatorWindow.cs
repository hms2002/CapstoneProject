...
public sealed class SceneSetupValidatorWindow : EditorWindow
{
    ...
    private const string ShopSlotPrefabPath = "Assets/_Project/Prefabs/UI/Dialogue/ShopSlot.prefab";
    private const string UpgradeTreePanelPrefabPath = "Assets/_Project/Prefabs/UI/Upgrade/UpgradeTreePanel.prefab";
    ...
    private void AutoFixDialogueViews(Scene scene)
    {
        ...
        foreach (DialogueView view in views)
        {
            ...
            {
                GameObject choiceButtonPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/UI/Choice0.prefab");
    ...
    private void AutoFixUpgradeTrees(Scene scene)
    {
        ...
        foreach (UpgradeTreeUI tree in trees)
        {
            ...
            {
                GameObject slotPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/UI/Upgrade/UpgradeSlot.prefab");
                if (slotPrefab != null)
            ...
            {
                GameObject linePrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/UI/Upgrade/line.prefab");
                if (linePrefab != null)
