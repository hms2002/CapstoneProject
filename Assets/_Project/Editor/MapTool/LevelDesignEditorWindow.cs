...
public sealed class LevelDesignEditorWindow : EditorWindow
{
    ...
    private const string LeverPrefabPath = "Assets/_Project/Prefabs/Map/ShortCut/Lever.prefab";
    ...
    private const string KillLockChestPrefabPath = "Assets/_Project/Prefabs/Items/Chests/KillLockTresureChest.prefab";
    private const string LowRewardChestPrefabPath = "Assets/_Project/Prefabs/Items/Chests/LowRewardTreasureChest.prefab";
    private const string LowRewardKillLockChestPrefabPath = "Assets/_Project/Prefabs/Items/Chests/LowRewardKillLockTreasureChest.prefab";
    private const string PortalPrefabPath = "Assets/_Project/Prefabs/Map/Portal/ScenePortal.prefab";
    private const string MonsterPrefabRoot = "Assets/_Project/Prefabs/Monsters";
