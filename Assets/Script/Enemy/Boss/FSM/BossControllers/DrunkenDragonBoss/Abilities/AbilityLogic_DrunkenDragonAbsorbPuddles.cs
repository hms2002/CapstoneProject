...
/// </summary>
[CreateAssetMenu(fileName = "AL_DrunkenDragonAbsorbPuddles", menuName = "GAS/Ability Logic/Drunken Dragon/AL_DrunkenDragonAbsorbPuddles")]
public sealed class AbilityLogic_DrunkenDragonAbsorbPuddles : AbilityLogic
{
    ...
    private IEnumerator MoveToArenaCenter(DrunkenDragonController dragon, AbilitySpec spec)
    {
        if (dragon == null)
            yield break;
    ...
    private void ApplyCenterImpactDamage(DrunkenDragonController dragon, Vector2 impactPosition)
    {
    ...
    private CombatHitPayload MakeCenterImpactPayload(DrunkenDragonController dragon)
    {
    ...
    private IEnumerator RunAbsorb(DrunkenDragonController dragon, AbilitySpec spec)
    {
    ...
    /// </summary>
    private static void SpeakAbsorbResult(DrunkenDragonController dragon)
    {
        if (dragon == null)
            return;

        DrunkenDragonRuntimeData data = dragon.RuntimeData;
    ...
    private void ConvertAllGroundPuddles(DrunkenDragonController dragon)
    {
    ...
    private void HandlePuddleArrivedAtBoss(DrunkenDragonController dragon, PuddleAreaBase puddle)
    {
        ...
        float addedStaggerBuildUp)
    {
        ...
        Debug.Log(
            $"[DrunkenDragonAbsorb] absorbed {puddle.ElementType} projectile. " +
    ...
    private void ApplyTargetPull(DrunkenDragonController dragon)
    {
    ...
    private void RemoveTargetPull(DrunkenDragonController dragon)
    {
    ...
    private void LogAbsorbResult(DrunkenDragonController dragon)
    {
        ...
        DrunkenDragonRuntimeData data = dragon.RuntimeData;
        Debug.Log(
            $"[DrunkenDragonAbsorb] result alcohol={data.AbsorbedAlcoholProjectileCount}, fire={data.AbsorbedFireProjectileCount}",
            dragon);
    }
}
