...
/// </summary>
[CreateAssetMenu(fileName = "AL_DrunkenDragonRotation", menuName = "GAS/Ability Logic/Drunken Dragon/AL_DrunkenDragonRotation")]
public sealed class AbilityLogic_DrunkenDragonRotation : AbilityLogic
{
    ...
    public override IEnumerator Activate(AbilitySystem system, AbilitySpec spec, GameObject initialTarget)
    {
        ...
        try
        {
            ...
            dragon.PlayPatternTrigger(DrunkenDragonAnimationKeys.Rotation);
    ...
    private IEnumerator RunSpin(DrunkenDragonController dragon, AbilitySpec spec)
    {
        nextDamageAllowedTimes.Clear();
        ...
        Vector3 baseLocalPosition)
    {
        ...
        Debug.Log(
            $"[DrunkenDragonRotation] Visual sway start. target={targetName}, rootFallback={isRootFallback}, baseLocal={baseLocalPosition}, amplitude={visualSwayAmplitude}, frequency={visualSwayFrequency}",
            dragon);
    }
    ...
    private void LogVisualSwayTick(Transform visualRoot, float elapsed, float offset)
    {
        ...
        Debug.Log(
            $"[DrunkenDragonRotation] Visual sway tick. elapsed={elapsed:F2}, offset={offset:F3}, local={visualRoot.localPosition}",
            visualRoot);
    }
    ...
    private void LogVisualSwayEnd(Transform visualRoot, Vector3 baseLocalPosition)
    {
        ...
        Debug.Log(
            $"[DrunkenDragonRotation] Visual sway end. restoredLocal={baseLocalPosition}",
            visualRoot);
    }
    ...
    private void ApplyAreaHit(DrunkenDragonController dragon)
    {
    ...
    private void SpawnRandomProjectile(DrunkenDragonController dragon, List<GameObject> spawnedProjectiles)
    {
        ...
        DrunkenDragonSpinProjectile2D projectile = projectileObject.GetComponent<DrunkenDragonSpinProjectile2D>();
    ...
    private CombatHitPayload MakeAreaHitPayload(DrunkenDragonController dragon)
    {
    ...
    private CombatHitPayload MakeProjectileHitPayload(DrunkenDragonController dragon)
    {
        CombatDamageSnapshot snapshot = new(
