...
/// </summary>
public sealed class DrunkenDragonDialogueStartKnotSelector : MonoBehaviour, IDialogueStartKnotSelector
{
    [SerializeField] private string defaultStartKnot = "DRUNK_01";
