...
public sealed class WitchBasicAttack2RingTelegraph : MonoBehaviour
{
    // 이 클래스의 책임:
    // 마녀 보스 평타2 전용 도넛 텔레그래프를 셰이더 기반 radial fill로 표시하고, inner/outer 반경은 고정한 채 진행도만 갱신한다.
    ...
    private void BuildSprites(float normalizedInner)
    {
        ...
        fillSprite = MakeSprite(fillTexture, "WitchBasicAttack2RingFill");
        borderSprite = MakeSprite(borderTexture, "WitchBasicAttack2RingBorder");
