...
public static class WeaponRigAuthoringTools
{
    ...
    private const string EquipPrefabFolder = "Assets/HeoMinSeok/_Project/Prefabs/Gameplay/Items/Weapons/Equip";
    private const string LightningSpearPrefabFolder = "Assets/HeoMinSeok/_Project/Prefabs/Items/Weapons/LightningSpear";
