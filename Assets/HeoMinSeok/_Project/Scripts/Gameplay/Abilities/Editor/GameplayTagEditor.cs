...
namespace UnityGAS
{
    public class GameplayTagEditor : EditorWindow
    {
        ...
        private const string TagAssetPath = "Assets/HeoMinSeok/_Project/Data/Abilities/Resources/Tags";
        private const string GeneratedScriptPath = "Assets/HeoMinSeok/_Project/Scripts/UGAS_Tags.cs";
