...
public static class DemonKingEndingAuthoringTool
{
    ...
    private const string EndingDialoguePath = "Assets/LeeJunMo/Datas/Inks/DemonKingEndingDialogue.json";
    private const string ExpectedNpcDataPath = "Assets/LeeJunMo/Datas/Dialogue/NPC/DarkLordNpcData.asset";
