...
public static class DarkLordTutorialAuthoringTool
{
    ...
    private const string DarkLordNpcDataPath = "Assets/LeeJunMo/Datas/Dialogue/NPC/DarkLordNpcData.asset";
    private const string Script1JsonPath = "Assets/LeeJunMo/Datas/Inks/TutorialDarkLordScript1.json";
    private const string Script2JsonPath = "Assets/LeeJunMo/Datas/Inks/TutorialDarkLordScript2.json";
    private const string LaserVfxPrefabPath = "Assets/Resources/DemonKing/DemonKingEgoLaserVfx.prefab";
    private const string GlobalUiRootPrefabPath = "Assets/LeeJunMo/Prefab/UI/GlobalUIRoot.prefab";
    private const string HeartTokenPrefabPath = "Assets/HeoMinSeok/_Project/Prefabs/UI/HUD/HeartTokenUI.prefab";
