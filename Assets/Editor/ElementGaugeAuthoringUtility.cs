...
{
    private const string CatalogPath = "Assets/HeoMinSeok/_Project/Data/Combat/ElementDamage/Element Gauge Catalog.asset";
    private const string ViewPrefabPath = "Assets/Prefabs/UI/ElementGaugeUI/Canvas_MonstarElementGaugeView.prefab";
