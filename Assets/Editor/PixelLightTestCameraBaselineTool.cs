    ...
    private static void ApplyBaseline(bool askForConfirmation, bool restoreSceneSetup)
    {
        ...
        if (askForConfirmation)
        {
            bool confirmed = EditorUtility.DisplayDialog(
                ...
                "This will open and save Assets/Scenes/PixelLightTest.unity. The scene Main Camera will get the URP Pixel Perfect Camera baseline: Assets PPU 16, Reference Resolution 1280x720, Point filter mode, Orthographic, HDR, and Post Processing.",
                "Apply And Save",
                "Cancel");
