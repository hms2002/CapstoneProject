...
public static class HubIntroAfterDarkLordAuthoringTool
{
    ...
    private const string DraftNpcDataPath = "Assets/LeeJunMo/Datas/Dialogue/NPC/MSUpgradeNpc.asset";
    private const string DraftInkFolder = "Assets/LeeJunMo/Datas/Inks/HubIntroAfterDarkLord";
    ...
    {
        EnsureAssetFolder("Assets/LeeJunMo/Datas", "Inks");
        EnsureAssetFolder("Assets/LeeJunMo/Datas/Inks", "HubIntroAfterDarkLord");
