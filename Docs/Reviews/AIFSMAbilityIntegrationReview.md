...
- [BossPatternExecuteState.cs](../../Assets/Script/Enemy/Boss/FSM/States/BossPatternExecuteState.cs)
...
현재 [GAS_Actions.cs](../../Assets/Script/Enemy/Boss/Behavior/GAS_Actions.cs)는:
...
[TackleAttack.cs](../../Assets/Script/Enemy/Mob/TackleAttack.cs)는 direct call은 많이 줄었지만, 여전히 아래 문맥을 함께 들고 있습니다.
...
[ShadowServant.cs](../../Assets/Script/Enemy/Mob/ShadowServant/ShadowServant.cs)와
[StrangeCandlestick.cs](../../Assets/Script/Enemy/Mob/StrangeCandlestick/StrangeCandlestick.cs)는 초기화 단계에서 runtime ability definition을 만들고 `abilitySystem.GiveAbility(...)`를 호출합니다.
