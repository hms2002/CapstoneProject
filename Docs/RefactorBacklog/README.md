...
| P2 | [Run Special NPC Scene Authoring Completion](./RunSpecialNpcSceneAuthoringCompletion.md) | proposed | SlimeCorridor's placed ConstructionNpc currently uses direct blocked-root fallback and explicit single-choice execution until the authored ConstructionSite module and speech-bubble choice presenter exist. | SlimeCorridor shortcut layout finalization, adding the next construction site NPC, or removing presenterless compatibility flow. |
| P2 | [Encyclopedia Deferred Categories](./EncyclopediaDeferredCategories.md) | proposed | The encyclopedia is intentionally narrowed to the item/weapon slice while Monster, Boss, Relic, and Consumable layouts are not yet authored. | Item/Weapon page acceptance, Relic/Consumable sub-tab work, Monster theme-tab work, or Boss-specific detail work. |
...
- [Run Special NPC Scene Authoring Completion](./RunSpecialNpcSceneAuthoringCompletion.md)
- [Encyclopedia Deferred Categories](./EncyclopediaDeferredCategories.md)
